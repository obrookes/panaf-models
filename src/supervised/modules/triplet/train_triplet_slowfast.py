...
def main():
    ...
    val_top1_acc_checkpoint_callback = ModelCheckpoint(
        dirpath=f"checkpoints/val_top1_acc/type={data_type}_margin={margin}_model={model_name}_triplets={type_of_triplets}",
        monitor="val_top1_acc",
        mode="max",
    )

    val_per_class_acc_checkpoint_callback = ModelCheckpoint(
        dirpath=f"checkpoints/val_per_class_acc/type={data_type}_margin={margin}_model={model_name}_triplets={type_of_triplets}",
